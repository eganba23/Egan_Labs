...
This first graph can be used to remind people that COVID cases are still prevalent in the no-mask counties.
...
This graph is an alternate option to the second visualization. We can also drop the y axis entirely to further change the data. This way we further push the daily changes as the most important feature instead of the actual number of cases.